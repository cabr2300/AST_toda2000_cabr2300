...
public final class AppConfig {
     ...
     */
    public static final String GPT_API_KEY = "gpt API key placeholder"; //TODO replace with real key

    /**
     * The private API key used for the Claude API
     */
    public static final String CLAUDE_API_KEY = "claude API key placeholder"; //TODO replace with real key
     ...
     */
    public static final String PROMPTS_JSON = "data/prompts.json";
